...
public class TableTests_consultation {
    WebDriver driver;
    ...
    @Test
    public void findElementInTableWithCss(){
        //numbers of Rows
    ...
    @Test
    public void findElementInTableWithXpath(){
        //numbers of Rows
        ...
        for (int i = 0;  i< tr.size(); i++) {
            ...
            System.out.println("========================");
            //print row 2
            List<WebElement> row2 = driver.findElements(By.xpath("//* [@id='customers']//tr[2]//td "));
            for (WebElement element :row2) {
                System.out.println(element.getText());
            }
